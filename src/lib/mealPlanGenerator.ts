...
const CORE_LUNCH_RECIPES: Recipe[] = [
  {
    ...
    ingredients: ["200g kipfilet", "100g fetakaas", "1 komkommer", "250g cherrytomaatjes", "1 rode ui", "40g olijven", "2 el olijfolie", "sap van halve citroen", "oregano, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["200g rode linzen", "200g wortelen", "100g selderij", "1 ui", "2 teentjes knoflook", "400g gepelde tomaten", "1 tl komijn", "1 tl kurkuma", "1 liter groentebouillon", "80g volkorenbrood"],
  ...
  },
  {
    ...
    ingredients: ["160g tonijn op water", "1 avocado", "130g volkoren wraps", "50g spinazie", "4 el Griekse yoghurt", "sap van halve citroen", "zout, peper, bieslook"],
  ...
  },
  {
    ...
    ingredients: ["500g rijpe tomaten", "400g gepelde tomaten", "1 ui", "2 teentjes knoflook", "2 el tomatenpuree", "500ml groentebouillon", "verse basilicum", "80g volkorenbrood", "100g hummus"],
  ...
  },
  {
    ...
    ingredients: ["240g eieren (4 stuks)", "3 el Griekse yoghurt", "1 tl dijonmosterd", "bieslook, peterselie", "zout, peper", "160g roggebrood", "50g sla", "½ komkommer"],
  ...
  },
  {
    ...
    ingredients: ["1500ml groentebouillon", "100g kleine volkoren pasta", "200g wortelen", "1 courgette", "100g erwtjes", "100g selderij", "1 ui", "peterselie, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["200g gekookte kipfilet", "1500ml kippenbouillon", "200g wortelen", "1 prei", "100g vermicelli", "1 ui", "tijm, laurier, peterselie", "zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["100g gerookte zalm", "130g volkoren wraps", "100g light roomkaas", "½ komkommer", "verse dille", "sap van halve citroen", "40g rucola", "zout, peper"],
...
const CORE_DINNER_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: ["300g kipfilet in blokjes", "400ml kokosmelk (light)", "400g gepelde tomaten", "1 bloemkool", "2 el tikka masala pasta", "1 ui", "2 teentjes knoflook", "verse koriander"],
  ...
  },
  {
    ...
    ingredients: ["300g mager rundergehakt", "180g volkoren spaghetti", "800g gepelde tomaten", "1 ui", "3 teentjes knoflook", "60g ei (1 stuk)", "2 el paneermeel", "basilicum, oregano, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["4 paprika's", "200g quinoa", "400g zwarte bonen", "150g mais", "1 ui", "2 teentjes knoflook", "komijn, chilipoeder", "100g geraspte kaas (light)", "verse peterselie"],
  ...
  },
  {
    ...
    ingredients: ["250g kipfilet in reepjes", "180g zilvervliesrijst", "1 broccoli", "200g wortelen", "1 paprika", "3 el sojasaus (laag zout)", "1 el sesamolie", "2 teentjes knoflook", "verse gember", "10g sesamzaad"],
  ...
  },
  {
    ...
    ingredients: ["350g volkoren pizzadeeg", "200ml passata", "125g mozzarella (light)", "1 courgette", "1 paprika", "100g champignons", "1 rode ui", "verse basilicum", "oregano, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["800g kikkererwten (uitgelekt)", "300g verse spinazie", "400g gepelde tomaten", "1 ui", "3 teentjes knoflook", "ras el hanout, komijn, paprikapoeder", "200g volkoren couscous", "verse koriander"],
  ...
  },
  {
    ...
    ingredients: ["200g kabeljauwfilet", "200g boontjes", "200g wortelen", "1 courgette", "80g kerstomaatjes", "2 el olijfolie", "sap van halve citroen", "tijm, rozemarijn, zout, peper", "300g nieuwe aardappelen"],
...
import { EVEN_MORE_LUNCH_RECIPES, EVEN_MORE_DINNER_RECIPES } from "./recipesEvenMore";
import { MEGA_LUNCH_RECIPES } from "./recipesMega1";
import { MEGA_DINNER_RECIPES } from "./recipesMega2";
export const LUNCH_RECIPES: Recipe[] = [...CORE_LUNCH_RECIPES, ...EXTRA_LUNCH_RECIPES, ...EXTENDED_LUNCH_RECIPES, ...MORE_LUNCH_RECIPES, ...EVEN_MORE_LUNCH_RECIPES, ...MEGA_LUNCH_RECIPES];
export const DINNER_RECIPES: Recipe[] = [...CORE_DINNER_RECIPES, ...EXTRA_DINNER_RECIPES, ...EXTENDED_DINNER_RECIPES, ...MORE_DINNER_RECIPES, ...EVEN_MORE_DINNER_RECIPES, ...MEGA_DINNER_RECIPES];
