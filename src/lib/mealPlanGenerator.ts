...
export const LUNCH_RECIPES: Recipe[] = [...CORE_LUNCH_RECIPES, ...EXTRA_LUNCH_RECIPES, ...EXTENDED_LUNCH_RECIPES, ...MORE_LUNCH_RECIPES, ...EVEN_MORE_LUNCH_RECIPES];
export const DINNER_RECIPES: Recipe[] = [...CORE_DINNER_RECIPES, ...EXTRA_DINNER_RECIPES, ...EXTENDED_DINNER_RECIPES, ...MORE_DINNER_RECIPES, ...EVEN_MORE_DINNER_RECIPES];
