...
const LUNCH_RECIPES: Recipe[] = [
  {
    ...
    ingredients: ["200g kipfilet", "100g fetakaas", "1 komkommer", "250g cherrytomaatjes", "1 rode ui", "handvol olijven", "2 el olijfolie", "sap van ½ citroen", "oregano, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["200g rode linzen", "2 wortelen", "2 stengels selderij", "1 ui", "2 teentjes knoflook", "1 blik gepelde tomaten", "1 tl komijn", "1 tl kurkuma", "1 liter groentebouillon", "2 sneetjes volkorenbrood"],
  ...
  },
  {
    ...
    ingredients: ["1 blik tonijn op water", "1 avocado", "2 volkoren wraps", "handvol spinazie", "4 el Griekse yoghurt", "sap van ½ citroen", "zout, peper, bieslook"],
  ...
  },
  {
    ...
    ingredients: ["1 romanosla", "3 hardgekookte eieren", "30g parmezaan", "2 el olijfolie", "1 el citroensap", "1 tl dijonmosterd", "1 teentje knoflook", "worcestersaus, zout, peper", "volkorencroutons"],
  ...
  },
  {
    ...
    ingredients: ["500g rijpe tomaten", "1 blik gepelde tomaten", "1 ui", "2 teentjes knoflook", "2 el tomatenpuree", "500ml groentebouillon", "verse basilicum", "2 sneetjes volkorenbrood", "100g hummus"],
  ...
  },
  {
    ...
    ingredients: ["4 hardgekookte eieren", "3 el Griekse yoghurt", "1 tl dijonmosterd", "bieslook, peterselie", "zout, peper", "4 sneetjes roggebrood", "sla en komkommer"],
  ...
  },
  {
    ...
    ingredients: ["1.5 liter groentebouillon", "100g kleine volkoren pasta", "2 wortelen", "1 courgette", "100g erwtjes", "2 stengels selderij", "1 ui", "peterselie, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["200g gekookte kipfilet", "1.5 liter kippenbouillon", "2 wortelen", "1 prei", "100g vermicelli", "1 ui", "tijm, laurier, peterselie", "zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["100g gerookte zalm", "2 volkoren wraps", "100g light roomkaas", "½ komkommer", "verse dille", "sap van ½ citroen", "rucola", "zout, peper"],
    instructions: ["Smeer roomkaas op de wraps.", "Beleg met rucola en dun gesneden komkommer.", "Verdeel zalm erover en bestrooi met dille.", "Besprenkel met citroensap.", "Rol op, snijd doormidden en serveer."],
  },
];
...
const DINNER_RECIPES: Recipe[] = [
  {
    ...
    ingredients: ["200g zalmfilet", "300g zoete aardappel", "1 courgette", "1 rode paprika", "1 broccoli", "2 el olijfolie", "knoflook, rozemarijn, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["300g kipfilet in blokjes", "400ml kokosmelk (light)", "1 blik gepelde tomaten", "1 bloemkool", "2 el tikka masala pasta", "1 ui", "2 teentjes knoflook", "verse koriander"],
  ...
  },
  {
    ...
    ingredients: ["300g mager rundergehakt", "180g volkoren spaghetti", "2 blikken gepelde tomaten", "1 ui", "3 teentjes knoflook", "1 ei", "2 el paneermeel", "basilicum, oregano, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["4 paprika's", "200g quinoa", "1 blik zwarte bonen", "150g maïs", "1 ui", "2 teentjes knoflook", "komijn, chilipoeder", "100g geraspte kaas (light)", "verse peterselie"],
    instructions: ["Verwarm oven op 190°C.", "Kook quinoa gaar.", "Fruit ui en knoflook, voeg bonen, maïs en kruiden toe.", "Meng met quinoa.", "Halveer paprika's en verwijder zaadjes.", "Vul met quinoamengsel en bestrooi met kaas.", "Bak 25 min in oven tot paprika zacht is."],
  },
  {
    ...
    ingredients: ["250g kipfilet in reepjes", "180g zilvervliesrijst", "1 broccoli", "2 wortelen", "1 paprika", "3 el sojasaus (laag zout)", "1 el sesamolie", "2 teentjes knoflook", "verse gember", "sesamzaad"],
  ...
  },
  {
    ...
    ingredients: ["200g tilapiafilet", "300g groene asperges", "300g kleine aardappelen", "2 el olijfolie", "citroen", "dille, zout, peper"],
  ...
  },
  {
    ...
    ingredients: ["2 volkoren pizzabodems", "200ml passata", "125g mozzarella (light)", "1 courgette", "1 paprika", "100g champignons", "rode ui", "verse basilicum", "oregano, zout, peper"],
    instructions: ["Verwarm oven op 220°C.", "Smeer passata op bodems.", "Snijd groenten dun en verdeel erover.", "Scheur mozzarella in stukken en verdeel.", "Bestrooi met oregano en bak 12-15 min.", "Garneer met verse basilicum voor serveren."],
  },
  {
    ...
    ingredients: ["2 blikken kikkererwten", "300g verse spinazie", "1 blik gepelde tomaten", "1 ui", "3 teentjes knoflook", "ras el hanout, komijn, paprikapoeder", "200g volkoren couscous", "verse koriander"],
  ...
  },
  {
    ...
    ingredients: ["200g kabeljauwfilet", "200g boontjes", "2 wortelen", "1 courgette", "4 kerstomaatjes", "2 el olijfolie", "citroen", "tijm, rozemarijn, zout, peper", "300g nieuwe aardappelen"],
  ...
  {
    name: "Turkse köfte met tzatziki en rijst",
    ...
    ingredients: ["300g mager rundergehakt", "180g zilvervliesrijst", "1 ui (geraspt)", "2 teentjes knoflook", "komijn, koriander, paprikapoeder", "200g Griekse yoghurt", "½ komkommer", "verse munt en dille", "zout, peper"],
    instructions: ["Meng gehakt met ui, knoflook en kruiden.", "Vorm kleine rolletjes en grill 10-12 min op grillpan.", "Rasp komkommer, knijp vocht eruit.", "Meng met yoghurt, munt, dille en knoflook tot tzatziki.", "Kook rijst gaar.", "Serveer köfte op rijst met tzatziki."],
  },
];
